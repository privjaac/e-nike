...
export interface ICatalogRepository {
  findAll(filters: { sport?: string; gender?: string; search?: string; size?: string; sale?: boolean; limit: number; offset: number }): Promise<Product[]>;
  count(filters: { sport?: string; gender?: string; search?: string; size?: string; sale?: boolean }): Promise<number>;
